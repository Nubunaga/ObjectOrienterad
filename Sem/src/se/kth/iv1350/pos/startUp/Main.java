...
import se.kth.iv1350.pos.databasetest.*;
import se.kth.iv1350.pos.view.*;
/************************************************/
public class Main {
    public static void main(String[] args)throws Exception{
        /*Classes for the se.kth.iv1350.pos.databasetest file be created here, These are made to se.kth.iv1350.pos.databasetest the different part of the program.*/
        ...
        Controller contr = new Controller(inv,reg);        //parameters inv,exAccSys used by se.kth.iv1350.pos.controller and sub classes
        new Printer();
